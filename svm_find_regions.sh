...
if [ $# -ne $EXPECTED_ARGS ]
then
  echo "Usage: svm_find_regions.sh input_train.fasta input_kabat input_predict.fasta svm_window_size avg_window_size merge_threshold"
  exit
fi
...
python ./parse_svm_output.py data.txt $5 $4 $6
